 ...
 *         &lt;element name="OrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}SupplierOrderItemType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="RetailerOrderID" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ID_Type" minOccurs="0"/&gt;
 *         &lt;element name="RetailerOwnerCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AirlineDesigCodeType"/&gt;
...
@XmlType(name = "SupplierOrderType", propOrder = {
    "creationDateTime",
...
public class SupplierOrderType {
    ...
    protected List<SupplierOrderItemType> orderItem;
    ...
    @XmlElement(name = "RetailerOwnerCode", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * {@link SupplierOrderItemType }
     * 
     * 
     */
    public List<SupplierOrderItemType> getOrderItem() {
        if (orderItem == null) {
            orderItem = new ArrayList<SupplierOrderItemType>();
        }
