 ...
 * 
 */
@XmlType(name = "OwnerTypeCodeContentType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional")
@XmlEnum
public enum OwnerTypeCodeContentType2 {
    ...
    public static OwnerTypeCodeContentType2 fromValue(String v) {
        return valueOf(v);
    }
