 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ClearancePayee" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}ClearancePayeeType" minOccurs="0"/&gt;
 *         &lt;element name="ClearancePayeeReconciliationID" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}AirlineRefID_Type" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ClearancePayeeDataType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "clearancePayee",
    "clearancePayeeReconciliationID"
})
public class ClearancePayeeDataType2 {

    @XmlElement(name = "ClearancePayee")
    protected ClearancePayeeType2 clearancePayee;
     ...
     * @return
     *     possible object is
     *     {@link ClearancePayeeType2 }
     *     
     */
    public ClearancePayeeType2 getClearancePayee() {
     ...
     *     
     */
    public void setClearancePayee(ClearancePayeeType2 value) {
