...
@XmlType(name = "FieldMetadataType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "mandatoryInd",
    "pathText"
})
public class FieldMetadataType2 {
