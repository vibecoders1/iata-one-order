...
@XmlType(name = "ServiceFilterCriteriaType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "bookingRef",
    "deliveryStatusCode",
    "descText",
...
public class ServiceFilterCriteriaType2 {
