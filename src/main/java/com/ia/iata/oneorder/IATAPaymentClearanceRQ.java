...
@XmlRootElement(name = "IATA_PaymentClearanceRQ", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearanceRQ")
public class IATAPaymentClearanceRQ {

    @XmlElement(name = "Clearance", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearanceRQ", required = true)
    protected List<ClearanceRequestType> clearance;
    @XmlElement(name = "ClearanceCount", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearanceRQ", required = true)
    protected BigInteger clearanceCount;
    @XmlElement(name = "PayloadStandardAttributes", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearanceRQ")
