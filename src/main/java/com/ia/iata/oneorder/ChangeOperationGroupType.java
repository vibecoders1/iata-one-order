 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ChangeOperation" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersMessage}ChangeOperationType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "ChangeOperationGroupType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersMessage", propOrder = {
    "changeOperation",
    "distributionChain",
    "orderVersionNumber"
})
public class ChangeOperationGroupType {
    ...
    @XmlElement(name = "DistributionChain")
