 ...
 *         &lt;element name="RefundMethodText" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}NameType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalRefundableTaxAmount" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}AmountType" minOccurs="0"/&gt;
 *         &lt;element name="TotalTaxAmount" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}AmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TaxSummaryType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "allRefundableInd",
    "approximateInd",
    "collectionInd",
...
public class TaxSummaryType2 {
    ...
    protected AmountType2 totalRefundableTaxAmount;
    @XmlElement(name = "TotalTaxAmount")
    protected AmountType2 totalTaxAmount;
     ...
     *     
     */
    public AmountType2 getTotalRefundableTaxAmount() {
     ...
     *     
     */
    public void setTotalRefundableTaxAmount(AmountType2 value) {
     ...
     *     
     */
    public AmountType2 getTotalTaxAmount() {
     ...
     *     
     */
    public void setTotalTaxAmount(AmountType2 value) {
