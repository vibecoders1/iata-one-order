...
@XmlType(name = "SelectedOfferType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "offerRefID",
    "ownerCode",
    "selectedOfferItem"
})
public class SelectedOfferType2 {
