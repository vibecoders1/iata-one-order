 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ActionCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}SellerFollowupActionCodeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ActionInd" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 *         &lt;element name="ActionTimeLimitDateTime" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}DateTimeType" minOccurs="0"/&gt;
 *         &lt;element name="AirlineContactURI" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}URI_Type" minOccurs="0"/&gt;
 *         &lt;element name="ConsequenceOfInactionCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}ConsequenceOfInactionCodeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "SellerFollowUpActionType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "actionCode",
    "actionInd",
...
public class SellerFollowUpActionType2 {
    ...
    @XmlSchemaType(name = "token")
    protected ConsequenceOfInactionCodeContentType2 consequenceOfInactionCode;
     ...
     * @return
     *     possible object is
     *     {@link ConsequenceOfInactionCodeContentType2 }
     *     
     */
    public ConsequenceOfInactionCodeContentType2 getConsequenceOfInactionCode() {
     ...
     *     
     */
    public void setConsequenceOfInactionCode(ConsequenceOfInactionCodeContentType2 value) {
