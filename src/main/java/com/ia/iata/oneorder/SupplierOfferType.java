 ...
 *         &lt;element name="SupplierOfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}SupplierOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SupplierOfferType", propOrder = {
...
public class SupplierOfferType {
    ...
    protected List<SupplierOfferItemType> supplierOfferItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SupplierOfferItemType }
     * 
     * 
     */
    public List<SupplierOfferItemType> getSupplierOfferItem() {
        if (supplierOfferItem == null) {
            supplierOfferItem = new ArrayList<SupplierOfferItemType>();
        }
