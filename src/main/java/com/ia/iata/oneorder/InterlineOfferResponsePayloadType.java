 ...
 *         &lt;element name="InterlineOffers" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}SupplierOfferType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OptionalOffers" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}InterlineALaCarteOfferType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "InterlineOfferResponsePayloadType", propOrder = {
...
public class InterlineOfferResponsePayloadType {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SupplierOfferType }
     * 
     * 
     */
    public List<SupplierOfferType> getInterlineOffers() {
        if (interlineOffers == null) {
            interlineOffers = new ArrayList<SupplierOfferType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InterlineALaCarteOfferType }
     * 
     * 
     */
    public List<InterlineALaCarteOfferType> getOptionalOffers() {
        if (optionalOffers == null) {
            optionalOffers = new ArrayList<InterlineALaCarteOfferType>();
        }
