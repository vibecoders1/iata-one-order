 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AffectedOrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AffectedOrderItemRequestType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ExistingOrderType", propOrder = {
    "affectedOrderItem",
    "orderID",
    "orderVersionNumber",
    "ownerCode"
})
public class ExistingOrderType {

    @XmlElement(name = "AffectedOrderItem")
    protected List<AffectedOrderItemRequestType> affectedOrderItem;
     ...
     * {@link AffectedOrderItemRequestType }
     * 
     * 
     */
    public List<AffectedOrderItemRequestType> getAffectedOrderItem() {
        if (affectedOrderItem == null) {
            affectedOrderItem = new ArrayList<AffectedOrderItemRequestType>();
        }
