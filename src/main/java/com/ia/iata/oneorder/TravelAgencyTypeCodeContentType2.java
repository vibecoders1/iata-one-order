 ...
 * 
 */
@XmlType(name = "TravelAgencyTypeCodeContentType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional")
@XmlEnum
public enum TravelAgencyTypeCodeContentType2 {
    ...
    TravelAgencyTypeCodeContentType2(String v) {
        value = v;
    }
    ...
    public static TravelAgencyTypeCodeContentType2 fromValue(String v) {
        for (TravelAgencyTypeCodeContentType2 c: TravelAgencyTypeCodeContentType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
