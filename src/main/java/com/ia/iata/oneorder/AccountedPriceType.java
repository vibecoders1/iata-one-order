 ...
 *         &lt;element name="VAT_BreakdownElement" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}VAT_BreakdownElementType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AccountedPriceType", propOrder = {
    "baseAmount",
...
public class AccountedPriceType {
    ...
    protected List<VATBreakdownElementType> vatBreakdownElement;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VATBreakdownElementType }
     * 
     * 
     */
    public List<VATBreakdownElementType> getVATBreakdownElement() {
        if (vatBreakdownElement == null) {
            vatBreakdownElement = new ArrayList<VATBreakdownElementType>();
        }
