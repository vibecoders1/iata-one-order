 ...
 *         &lt;element name="OfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}SeatAvailOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SeatAvailOfferType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "offerID",
    "offerItem",
    "ownerCode"
})
public class SeatAvailOfferType2 {
    ...
    protected List<SeatAvailOfferItemType2> offerItem;
     ...
     * {@link SeatAvailOfferItemType2 }
     * 
     * 
     */
    public List<SeatAvailOfferItemType2> getOfferItem() {
        if (offerItem == null) {
            offerItem = new ArrayList<SeatAvailOfferItemType2>();
        }
