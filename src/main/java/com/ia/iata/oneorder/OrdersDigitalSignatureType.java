...
@XmlType(name = "DigitalSignatureType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "signatureType"
})
public class OrdersDigitalSignatureType {
