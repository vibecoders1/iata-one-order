 ...
 *         &lt;element name="OfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ServiceListOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ServiceListOfferType", propOrder = {
    "offerID",
    "offerItem",
    "ownerCode"
})
public class ServiceListOfferType {
    ...
    protected List<ServiceListOfferItemType> offerItem;
     ...
     * {@link ServiceListOfferItemType }
     * 
     * 
     */
    public List<ServiceListOfferItemType> getOfferItem() {
        if (offerItem == null) {
            offerItem = new ArrayList<ServiceListOfferItemType>();
        }
