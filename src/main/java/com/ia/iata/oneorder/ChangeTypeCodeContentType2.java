 ...
 * 
 */
@XmlType(name = "ChangeTypeCodeContentType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional")
@XmlEnum
public enum ChangeTypeCodeContentType2 {
    ...
    ChangeTypeCodeContentType2(String v) {
        value = v;
    }
    ...
    public static ChangeTypeCodeContentType2 fromValue(String v) {
        for (ChangeTypeCodeContentType2 c: ChangeTypeCodeContentType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
