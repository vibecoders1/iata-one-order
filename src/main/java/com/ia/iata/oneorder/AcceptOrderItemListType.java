 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CreateOrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}CreateOrderItemType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AcceptOrderItemListType", propOrder = {
    "createOrderItem"
})
public class AcceptOrderItemListType {

    @XmlElement(name = "CreateOrderItem", required = true)
