 ...
 * 
 */
@XmlType(name = "LengthUnitCodeContentType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional")
@XmlEnum
public enum LengthUnitCodeContentType2 {
    ...
    public static LengthUnitCodeContentType2 fromValue(String v) {
        return valueOf(v);
    }
