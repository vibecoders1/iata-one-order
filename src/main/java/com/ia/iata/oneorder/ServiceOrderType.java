 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AddOfferItems" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AddOfferItemsType" minOccurs="0"/&gt;
 *         &lt;element name="DeleteOrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AffectedOrderItemRequestType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ServiceOrderType {
    ...
    protected List<AffectedOrderItemRequestType> deleteOrderItem;
     ...
     * 
     */
    public List<AffectedOrderItemRequestType> getDeleteOrderItem() {
        if (deleteOrderItem == null) {
            deleteOrderItem = new ArrayList<AffectedOrderItemRequestType>();
        }
