 ...
 *         &lt;element name="FarePriceType" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AccountingFarePriceTypeType" maxOccurs="2" minOccurs="0"/&gt;
...
@XmlType(name = "AccountedFareDetailType", propOrder = {
    "accountCode",
    "fareCalculationInfo",
    "fareComponent",
    "fareIndCode",
...
public class AccountedFareDetailType {
    ...
    protected List<AccountingFarePriceTypeType> farePriceType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AccountingFarePriceTypeType }
     * 
     * 
     */
    public List<AccountingFarePriceTypeType> getFarePriceType() {
        if (farePriceType == null) {
            farePriceType = new ArrayList<AccountingFarePriceTypeType>();
        }
