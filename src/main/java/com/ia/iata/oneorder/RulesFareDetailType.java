 ...
 *         &lt;element name="FarePriceType" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}FarePriceTypeType" maxOccurs="2"/&gt;
 ...
 *         &lt;element name="RulesFareComponent" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}RulesFareComponentType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "RulesFareDetailType", propOrder = {
    "accountCode",
    "fareCalculationInfo",
    "fareIndCode",
    "farePriceType",
...
public class RulesFareDetailType {
    ...
    protected List<RulesFareComponentType> rulesFareComponent;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RulesFareComponentType }
     * 
     * 
     */
    public List<RulesFareComponentType> getRulesFareComponent() {
        if (rulesFareComponent == null) {
            rulesFareComponent = new ArrayList<RulesFareComponentType>();
        }
