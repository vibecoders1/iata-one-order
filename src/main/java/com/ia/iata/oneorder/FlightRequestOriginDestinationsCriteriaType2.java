 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OriginDestCriteria" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}OriginDestCriteriaType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FlightRequestOriginDestinationsCriteriaType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "originDestCriteria"
})
public class FlightRequestOriginDestinationsCriteriaType2 {

    @XmlElement(name = "OriginDestCriteria")
    protected List<OriginDestCriteriaType2> originDestCriteria;
     ...
     * {@link OriginDestCriteriaType2 }
     * 
     * 
     */
    public List<OriginDestCriteriaType2> getOriginDestCriteria() {
        if (originDestCriteria == null) {
            originDestCriteria = new ArrayList<OriginDestCriteriaType2>();
        }
