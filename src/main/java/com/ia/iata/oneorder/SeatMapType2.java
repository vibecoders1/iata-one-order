 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CabinCompartment" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}CabinCompartmentType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SeatMapType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "cabinCompartment",
    "datedOperatingLegRefID",
    "paxSegmentRefID"
})
public class SeatMapType2 {

    @XmlElement(name = "CabinCompartment")
    protected List<CabinCompartmentType2> cabinCompartment;
     ...
     * {@link CabinCompartmentType2 }
     * 
     * 
     */
    public List<CabinCompartmentType2> getCabinCompartment() {
        if (cabinCompartment == null) {
            cabinCompartment = new ArrayList<CabinCompartmentType2>();
        }
