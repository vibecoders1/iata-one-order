...
@XmlType(name = "OfferAssociationType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "offerItemRefID",
    "offerRefID",
    "ownerCode"
})
public class OfferAssociationType2 {
