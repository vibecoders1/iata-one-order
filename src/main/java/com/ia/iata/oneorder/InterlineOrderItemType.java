 ...
 *         &lt;element name="Service" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}InterlineServiceType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "InterlineOrderItemType", propOrder = {
    "grandTotalAmount",
    "orderItemID",
    "orderItemTypeCode",
    "ownerCode",
...
public class InterlineOrderItemType {
    ...
    protected List<InterlineServiceType> service;
     ...
     * {@link InterlineServiceType }
     * 
     * 
     */
    public List<InterlineServiceType> getService() {
        if (service == null) {
            service = new ArrayList<InterlineServiceType>();
        }
        return this.service;
    }
