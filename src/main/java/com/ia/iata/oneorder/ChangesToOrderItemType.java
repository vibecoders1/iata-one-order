 ...
 *         &lt;element name="DiffPrice" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}PriceDifferentialType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Service" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ChangeToServiceType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ChangesToOrderItemType", propOrder = {
    "airlineTaxonomy",
    "bilateralTimeLimit",
    "cabinTypeList",
    "cancelRestrictions",
...
public class ChangesToOrderItemType {
    ...
    protected List<PriceDifferentialType> diffPrice;
    ...
    protected List<ChangeToServiceType> service;
     ...
     * 
     */
    public List<PriceDifferentialType> getDiffPrice() {
        if (diffPrice == null) {
            diffPrice = new ArrayList<PriceDifferentialType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ChangeToServiceType }
     * 
     * 
     */
    public List<ChangeToServiceType> getService() {
        if (service == null) {
            service = new ArrayList<ChangeToServiceType>();
        }
        return this.service;
    }
