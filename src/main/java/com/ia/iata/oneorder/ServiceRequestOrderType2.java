 ...
 *         &lt;element name="OrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}ServiceRequestOrderItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ServiceRequestOrderType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "orderID",
    "orderItem",
    "orderVersionNumber",
    "ownerCode"
})
public class ServiceRequestOrderType2 {
    ...
    protected List<ServiceRequestOrderItemType2> orderItem;
     ...
     * {@link ServiceRequestOrderItemType2 }
     * 
     * 
     */
    public List<ServiceRequestOrderItemType2> getOrderItem() {
        if (orderItem == null) {
            orderItem = new ArrayList<ServiceRequestOrderItemType2>();
        }
