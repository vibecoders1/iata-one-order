...
@XmlRootElement(name = "IATA_PaymentClearingListRQ", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearingListRQ")
public class IATAPaymentClearingListRQ {

    @XmlElement(name = "ClearingDate", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearingListRQ")
    protected List<ClearingDateType> clearingDate;
    @XmlElement(name = "ClearingID", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearingListRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected List<String> clearingID;
    @XmlElement(name = "PayloadStandardAttributes", namespace = "http://www.iata.org/IATA/2015/00/2022.1/IATA_PaymentClearingListRQ")
