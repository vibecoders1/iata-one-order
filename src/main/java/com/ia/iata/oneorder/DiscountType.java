 ...
 *         &lt;element name="DiscountAmount" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AmountType" minOccurs="0"/&gt;
 *         &lt;element name="DiscountContext" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}KeyValuePropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DiscountPercent" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}PercentType" minOccurs="0"/&gt;
 *         &lt;element name="PreDiscountedAmount" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DiscountType {
    ...
    protected List<KeyValuePropertyType> discountContext;
    ...
    public List<KeyValuePropertyType> getDiscountContext() {
        if (discountContext == null) {
            discountContext = new ArrayList<KeyValuePropertyType>();
        }
