...
@XmlType(name = "SettlementPlanType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "iataNumber",
    "paymentTypeCode"
})
public class SettlementPlanType2 {
