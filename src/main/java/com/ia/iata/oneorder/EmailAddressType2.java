...
@XmlType(name = "EmailAddressType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "contactTypeText",
    "emailAddressText"
})
public class EmailAddressType2 {
