 ...
 *         &lt;element name="CabinTypeAssociationChoice" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}CabinTypeAssociationChoiceType"/&gt;
...
@XmlType(name = "ShoppingRequestPaxSegmentType", propOrder = {
    "airlineTaxonomy",
...
public class ShoppingRequestPaxSegmentType {

    @XmlElement(name = "AirlineTaxonomy")
    protected List<AirlineTaxonomyType> airlineTaxonomy;
    @XmlElement(name = "CabinTypeAssociationChoice", required = true)
