 ...
 * 
 */
@XmlType(name = "DifferentialTypeCodeContentType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional")
@XmlEnum
public enum DifferentialTypeCodeContentType2 {
    ...
    DifferentialTypeCodeContentType2(String v) {
        value = v;
    }
    ...
    public static DifferentialTypeCodeContentType2 fromValue(String v) {
        for (DifferentialTypeCodeContentType2 c: DifferentialTypeCodeContentType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
