 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ClearanceCriteria" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ClearanceCriteriaType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="PaymentCriteriaAddlInfo" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}PaymentCriteriaAddlInfoType" minOccurs="0"/&gt;
...
public class PaymentMethodCriteriaType {
     ...
     * {@link ClearanceCriteriaType }
     * 
     * 
     */
    public List<ClearanceCriteriaType> getClearanceCriteria() {
        if (clearanceCriteria == null) {
            clearanceCriteria = new ArrayList<ClearanceCriteriaType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link PaymentCriteriaAddlInfoType }
     *     
     */
    public PaymentCriteriaAddlInfoType getPaymentCriteriaAddlInfo() {
     ...
     *     
     */
    public void setPaymentCriteriaAddlInfo(PaymentCriteriaAddlInfoType value) {
