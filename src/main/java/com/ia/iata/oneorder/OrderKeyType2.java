...
@XmlType(name = "OrderKeyType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "creationDateTime",
    "orderID",
    "orderVersionNumber",
    "ownerCode",
