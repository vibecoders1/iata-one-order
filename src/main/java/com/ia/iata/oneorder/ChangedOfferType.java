 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AddedOfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}AddedOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="BaggageAssociations" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}BaggageAssociationsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="DeleteOrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}OrderItemDeletionOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="JourneyOverview" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}JourneyOverviewType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}NameChangeOfferItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ChangedOfferType", propOrder = {
    "addedOfferItem",
    "baggageAssociations",
...
public class ChangedOfferType {

    @XmlElement(name = "AddedOfferItem")
    protected List<AddedOfferItemType> addedOfferItem;
    ...
    protected List<OrderItemDeletionOfferItemType> deleteOrderItem;
    ...
    protected List<NameChangeOfferItemType> offerItem;
     ...
     * {@link AddedOfferItemType }
     * 
     * 
     */
    public List<AddedOfferItemType> getAddedOfferItem() {
        if (addedOfferItem == null) {
            addedOfferItem = new ArrayList<AddedOfferItemType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OrderItemDeletionOfferItemType }
     * 
     * 
     */
    public List<OrderItemDeletionOfferItemType> getDeleteOrderItem() {
        if (deleteOrderItem == null) {
            deleteOrderItem = new ArrayList<OrderItemDeletionOfferItemType>();
        }
     ...
     * 
     */
    public List<NameChangeOfferItemType> getOfferItem() {
        if (offerItem == null) {
            offerItem = new ArrayList<NameChangeOfferItemType>();
        }
