 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConnectedDocNumber" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}NumberType" minOccurs="0"/&gt;
 *         &lt;element name="Coupon" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}CouponType" maxOccurs="4" minOccurs="0"/&gt;
 *         &lt;element name="ExchReissueInd" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 *         &lt;element name="FeeOwnerCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}AirlineDesigCodeType" minOccurs="0"/&gt;
 *         &lt;element name="PresentCreditCardInd" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 *         &lt;element name="PrimaryDocInd" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ReportingTypeCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}ReportingTypeCodeType" minOccurs="0"/&gt;
 *         &lt;element name="RoutingCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}CodeType" minOccurs="0"/&gt;
 *         &lt;element name="TaxOnEMD_Ind" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
...
@XmlType(name = "TicketType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "connectedDocNumber",
    "coupon",
    "exchReissueInd",
    "feeOwnerCode",
...
public class TicketType2 {
    ...
    protected List<CouponType2> coupon;
    ...
    @XmlElement(name = "ReportingTypeCode")
    @XmlSchemaType(name = "token")
    protected ReportingTypeCodeContentType2 reportingTypeCode;
     ...
     * 
     */
    public List<CouponType2> getCoupon() {
        if (coupon == null) {
            coupon = new ArrayList<CouponType2>();
        }
        return this.coupon;
    }
     ...
     * @return
     *     possible object is
     *     {@link ReportingTypeCodeContentType2 }
     *     
     */
    public ReportingTypeCodeContentType2 getReportingTypeCode() {
     ...
     *     
     */
    public void setReportingTypeCode(ReportingTypeCodeContentType2 value) {
