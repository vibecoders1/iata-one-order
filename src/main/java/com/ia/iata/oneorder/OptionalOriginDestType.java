 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DestCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}IATA_LocationCodeType" minOccurs="0"/&gt;
 *         &lt;element name="OriginCode" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}IATA_LocationCodeType" minOccurs="0"/&gt;
 *         &lt;element name="OriginDestID" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ID_Type"/&gt;
 *         &lt;element name="PaxJourneyRefID" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}ID_Type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "OptionalOriginDestType", propOrder = {
    "destCode",
    "originCode",
    "originDestID",
    "paxJourneyRefID"
})
public class OptionalOriginDestType {
    ...
    @XmlElement(name = "OriginDestID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
