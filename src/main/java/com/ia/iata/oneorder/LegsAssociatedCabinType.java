 ...
 *         &lt;element name="LegCabinType" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}CabinTypeType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LegsAssociatedCabinType", propOrder = {
    "datedOperatingLegRefID",
    "legCabinType"
})
public class LegsAssociatedCabinType {

    @XmlElement(name = "DatedOperatingLegRefID", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected List<String> datedOperatingLegRefID;
    @XmlElement(name = "LegCabinType", required = true)
    protected CabinTypeType legCabinType;
     ...
     *     
     */
    public CabinTypeType getLegCabinType() {
        return legCabinType;
    }
     ...
     *     
     */
    public void setLegCabinType(CabinTypeType value) {
