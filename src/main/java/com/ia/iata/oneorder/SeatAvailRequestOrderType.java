 ...
 *         &lt;element name="OrderItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}SeatAvailRequestOrderItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SeatAvailRequestOrderType", propOrder = {
    "orderID",
    "orderItem",
    "orderVersionNumber",
    "ownerCode"
})
public class SeatAvailRequestOrderType {
    ...
    protected List<SeatAvailRequestOrderItemType> orderItem;
     ...
     * {@link SeatAvailRequestOrderItemType }
     * 
     * 
     */
    public List<SeatAvailRequestOrderItemType> getOrderItem() {
        if (orderItem == null) {
            orderItem = new ArrayList<SeatAvailRequestOrderItemType>();
        }
