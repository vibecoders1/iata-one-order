 ...
 *         &lt;element name="OfferItem" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}NewOfferItemType" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "NewOfferType", propOrder = {
    "baggageAssociations",
...
public class NewOfferType {
    ...
    protected List<NewOfferItemType> offerItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NewOfferItemType }
     * 
     * 
     */
    public List<NewOfferItemType> getOfferItem() {
        if (offerItem == null) {
            offerItem = new ArrayList<NewOfferItemType>();
        }
