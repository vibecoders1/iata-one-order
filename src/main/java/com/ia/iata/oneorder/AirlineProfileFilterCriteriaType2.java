 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AirlineProfileCriteria" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}FilterAirlineProfileType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AllProfilesInd" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 *         &lt;element name="MediaURL_Ind" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional}IndType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AirlineProfileFilterCriteriaType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "airlineProfileCriteria",
    "allProfilesInd",
    "mediaURLInd"
})
public class AirlineProfileFilterCriteriaType2 {

    @XmlElement(name = "AirlineProfileCriteria")
    protected List<FilterAirlineProfileType2> airlineProfileCriteria;
     ...
     * {@link FilterAirlineProfileType2 }
     * 
     * 
     */
    public List<FilterAirlineProfileType2> getAirlineProfileCriteria() {
        if (airlineProfileCriteria == null) {
            airlineProfileCriteria = new ArrayList<FilterAirlineProfileType2>();
        }
