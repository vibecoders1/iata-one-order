...
@XmlType(name = "MarketingCarrierInfoType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "carrierDesigCode",
    "carrierName",
...
public class MarketingCarrierInfoType2 {
