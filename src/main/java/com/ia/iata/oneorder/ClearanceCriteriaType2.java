...
@XmlType(name = "ClearanceCriteriaType", namespace = "http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypesFullyOptional", propOrder = {
    "processRuleCode",
    "remittanceDate"
})
public class ClearanceCriteriaType2 {
